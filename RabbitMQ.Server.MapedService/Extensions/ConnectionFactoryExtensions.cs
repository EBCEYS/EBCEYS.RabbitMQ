...
namespace EBCEYS.RabbitMQ.Server.MappedService.Extensions
{
    internal static class ConnectionFactoryExtensions
    {
        ...
        internal static async Task<IConnection> CreateConnectionAsync(this ConnectionFactory factory, RabbitMQOnStartConfigs conf, string? clientName = null, CancellationToken token = default)
        {
