...
public static class ChannelExtensions
{
    ...
    /// <returns></returns>
    public static Task ExchangeDeclareAsync(this IChannel channel, ExchangeConfiguration configuration,
    ...
    /// <param name="token">The cancellation token.</param>
    /// <returns></returns>
    public static Task<QueueDeclareOk> QueueDeclareAsync(this IChannel channel, QueueConfiguration? configuration,
        CancellationToken token = default)
    {
    ...
    /// <param name="token">The cancellation token.</param>
    /// <returns></returns>
    public static Task BasicQosAsync(this IChannel channel, QoSConfiguration? qoSConfiguration,
        CancellationToken token = default)
    {
        return channel.BasicQosAsync(qoSConfiguration?.PrefetchSize ?? 0, qoSConfiguration?.PrefetchCount ?? 1,
            qoSConfiguration?.Global ?? false, token);
    }
}